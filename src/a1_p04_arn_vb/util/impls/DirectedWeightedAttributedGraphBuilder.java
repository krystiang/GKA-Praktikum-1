...
public class DirectedWeightedAttributedGraphBuilder
		extends
		AbstractBaseGraphBuilder<DirectedWeightedMultigraph<AttrVertex, DefaultWeightedEdge>, AttrVertex, DefaultEdge>
		implements GkaGraphBuilder<DirectedWeightedMultigraph<AttrVertex, DefaultWeightedEdge>> {

	public DirectedWeightedAttributedGraphBuilder() {
		state = EXPECT_HEADER;
		graph =
